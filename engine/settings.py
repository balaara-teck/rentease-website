...
SECRET_KEY = 'django-insecure-hoh)3t5sk-kzd!e)q+px!wmldavnin#*x9!@!wzm7k0ly)7hbm'
...
# Login settings
LOGIN_URL = 'login'
LOGIN_REDIRECT_URL = 'rentease:property_list'
LOGOUT_REDIRECT_URL = 'rentease:property_list'
...
EMAIL_PORT = 587
EMAIL_USE_TLS = True
EMAIL_HOST_USER = os.environ.get('EMAIL_HOST_USER', '')  # Set this in your environment variables
...
AUTHENTICATION_BACKENDS = [
    'RentEase.backends.EmailOrUsernameModelBackend',
